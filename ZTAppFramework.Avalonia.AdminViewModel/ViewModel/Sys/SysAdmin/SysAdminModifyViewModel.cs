...
{
    public class SysAdminModifyViewModel : DialogViewModelBase
    {
        ...
        #endregion
        public SysAdminModifyViewModel(SysAdminService SysAdminservice, OrganizeService organizeService, SysPostService sysPostService, RoleService SysRoleService)
        {
        ...
        {
            var r = await _sysPostService.GetPostList(new PageParam());
            if (r.Success)
